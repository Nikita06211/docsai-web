  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive w-full",
  {
    variants: {
      variant: {
        ...
        terminal:
          "bg-[#00ffaa] text-black border-2 border-[#00ffaa] font-mono hover:bg-transparent hover:text-[#00ffaa] transition-colors",
        "terminal-outline":
          "border-2 border-[#00ffaa] bg-transparent text-[#00ffaa] font-mono hover:bg-[#00ffaa] hover:text-black transition-colors",
        "terminal-ghost":
          "text-[#00ffaa] font-mono hover:bg-[#00ffaa]/10 hover:text-[#00ffaa] transition-colors",
        "terminal-destructive":
          "bg-red-500/20 text-red-400 border border-red-500/50 font-mono hover:bg-red-500/30 hover:border-red-500/70 transition-colors",
      },
      size: {
